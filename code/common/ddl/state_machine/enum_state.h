...
#include "../commands/enum_add_cmd_parser.h"
#include "../commands/enum_remove_cmd_parser.h"
...
namespace ddl {
	...
	namespace fsm {
			...
			clsm::i_cmd_state
		{
			...
			{
/* TODO:				auto const& editor = context< paramtree_editor >();
				auto path = editor.acc.where();
				auto nav = editor.nav;	// TODO: think schema_provider sig should change, surely doesn't need non-const ref to accessor?
