...
#ifndef __B2D_COMPONENTS_SENSORS_H
#define __B2D_COMPONENTS_SENSORS_H
...
namespace b2dc {
	...
	struct basic_contact_sensor_data
	{
	b2Shape* shape;
	};
	...
	*/
	...
	{
		// TODO: oversimplification to begin/end and a body, will have to change eventually
		virtual void on_contact(ContactType type, b2Body* body) = 0;
	};
