	  ...
	  case WM_KEYDOWN:
		  {
			  ...
			  if(esContext != NULL && esContext->keyFunc != NULL)
			  {
	  ...
	  case WM_INPUT:
		  if(GetActiveWindow() == hWnd)
		  {
			  ...
			  if (raw->header.dwType == RIM_TYPEMOUSE) 
			  {
				  ...
				  esContext = (ESContext*)(LONG_PTR)GetWindowLongPtr(hWnd, GWLP_USERDATA);
				  if ( esContext && esContext->mouseMoveFunc )
				  {
					  esContext->mouseMoveFunc ( esContext, xPosRelative, yPosRelative );
				  }
			  }
		  }
		  break;
