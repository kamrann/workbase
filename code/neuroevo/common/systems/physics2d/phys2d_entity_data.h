// phys2d_entity_data.h

#ifndef __NE_PHYS2D_ENTITY_DATA_H
#define __NE_PHYS2D_ENTITY_DATA_H
...
namespace sys {
	namespace phys2d {
		...
		struct entity_data
		{
			...
			Type type;
			type_val_t type_value;	// Specific to type (eg, for Agent, this will be a ??*)
