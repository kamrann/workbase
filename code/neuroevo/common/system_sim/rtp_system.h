...
/*	struct _SystemType
	...
	*/
	...
	public:
		...
		virtual agent_id register_agent(agent_specification const& spec) = 0;
...
//		virtual std::shared_ptr< i_property_values const > get_state_property_values() const = 0;
		...
		// TODO: Move to defn? Maybe take out completely, since core system implementation doesn't require drawer
