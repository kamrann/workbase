...
namespace prm {
	namespace fsm {
		...
		sc::result base_node_state::dispatch(nav_cmd const& cmd)
		{
		...
		sc::result base_node_state::dispatch(list_cmd const& cmd)
		{
			...
			if(cmd.nav)
			{
				...
				if(!path)
				{
					return discard_event();// todo: false;
				}
			...
			return discard_event();// true;
		}

		sc::result base_node_state::dispatch(setvalue_cmd const& cmd)
		{
			auto& editor = context< paramtree_editor >();
			auto acc = editor.acc;
		...
		sc::result base_node_state::dispatch(save_cmd const& cmd)
		{
			auto const& editor = context< paramtree_editor >();
			auto acc = editor.acc;
		...
		sc::result base_node_state::dispatch(load_cmd const& cmd)
		{
			auto& editor = context< paramtree_editor >();
			auto acc = editor.acc;
