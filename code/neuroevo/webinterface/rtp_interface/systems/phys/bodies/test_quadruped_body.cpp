...
namespace rtp_phys {
	...
	YAML::Node test_quadruped_body::spec::get_schema(YAML::Node const& param_vals)
	{
		auto schema = sb::list("Test Quadruped Params");
	...
	test_quadruped_body::spec* test_quadruped_body::spec::create_instance(YAML::Node const& param)
	{
		spec* s = new spec();
		agent_body_spec::create_base_instance(param, s);
		return s;
