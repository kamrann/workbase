...
namespace rtp
{
	std::string const i_controller::Names[] = {
		"Evolved",
		"Passive",
		"Interactive",
		"Database",
...
namespace YAML {
	...
	std::map< std::string, rtp::i_controller::Type > const convert< rtp::i_controller::Type >::mapping_ = {
		{ "Evolved", rtp::i_controller::Type::Evolved },
		{ "Passive", rtp::i_controller::Type::Passive },
		{ "Interactive", rtp::i_controller::Type::Interactive },
		{ "Database", rtp::i_controller::Type::Database },
		{ "Preset", rtp::i_controller::Type::Preset },
	};
}
...
namespace rtp {
	...
	std::string i_controller::update_schema_providor(prm::schema::schema_provider_map_handle provider, prm::qualified_path const& prefix, bool evolvable)
	{
